...
<script>
import PanThumb from '@/providers/components/PanThumb'
import MdInput from '@/providers/components/MDinput'
import Mallki from '@/providers/components/TextHoverEffect/Mallki'
import DropdownMenu from '@/providers/components/Share/dropdownMenu'
import waves from '@/providers/directive/waves/index.js' // 水波纹指令
